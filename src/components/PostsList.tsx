  ...
  return (
    <div className="space-y-8">
      {upcomingPosts.length > 0 && (
        <div>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Upcoming Posts ({upcomingPosts.length})</h2>
          <div className="space-y-4">
      ...
      {pastPosts.length > 0 && (
        <div>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Past Posts ({pastPosts.length})</h2>
          <div className="space-y-4">
            {pastPosts.map(post => (
              <PostCard key={post.id} post={post} />
            ))}
